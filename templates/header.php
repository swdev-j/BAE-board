    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar_headers">
            <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                <?php  foreach(array(array('index.php', 'Main'), array('list.php', 'List'), array('write.php', 'Write')) as $value) { ?>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?=$value[0]?>"><?=$value[1]?></a>
                    </li>
                <?php } ?>
                <!-- <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="/write.php">write</a>
                </li> -->
